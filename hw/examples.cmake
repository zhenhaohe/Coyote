...
if(NOT EXAMPLE EQUAL 0) 
    ...
    elseif(EXAMPLE STREQUAL "service_reconfiguration")
        ...
        set(N_CONFIG 4)
        set(N_REGIONS 2)
    elseif(EXAMPLE STREQUAL "bft")
        message("** BFT benchmarks. Force config.")
        set(EN_HLS 0)
        set(EN_STRM 1)
        set(EN_TCP_0 1)
        set(EN_BPSS 1)
        set(EN_ACLK 1)
        set(ACLK_F 250)
        add_subdirectory(hdl/operators/examples/bft/hls/host_intf)
        add_subdirectory(hdl/operators/examples/bft/hls/tcp_intf)
        add_subdirectory(hdl/operators/examples/bft/hls/authenticator)
        add_subdirectory(hdl/operators/examples/bft/hls/bft_role)
        add_subdirectory(hdl/operators/examples/bft/hls/ccl_engine)
        add_subdirectory(hdl/operators/examples/bft/hls/common)
    endif()
endif()