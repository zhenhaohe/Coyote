...
set_property -dict [list  CONFIG.C_PROBE1_WIDTH {64} CONFIG.C_PROBE6_WIDTH {64} CONFIG.C_PROBE9_WIDTH {64} CONFIG.C_PROBE12_WIDTH {64} CONFIG.C_PROBE13_WIDTH {8} CONFIG.C_PROBE17_WIDTH {64} CONFIG.C_NUM_OF_PROBES {18} CONFIG.Component_Name {ila_bench_role_slave} CONFIG.C_INPUT_PIPE_STAGES {1}] [get_ips ila_bench_role_slave]
update_compile_order -fileset sources_1
