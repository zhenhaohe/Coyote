...
module hmac_sha256_dup_strm2_Pipeline_VITIS_LOOP_506_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_phi_mux_e_9_phi_fu_109_p4 == 1'd0) & (ap_start_int == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        tmp_57_reg_117 <= end_nblk_strm11_dout;
    end
end
...
always @ (*) begin
    if ((1'b1 == ap_CS_fsm_pp0_stage0)) begin
        if ((1'b1 == ap_condition_173)) begin
            ap_phi_mux_e_9_phi_fu_109_p4 = tmp_57_reg_117;
...
endmodule //hmac_sha256_dup_strm2_Pipeline_VITIS_LOOP_506_1
