...
module hmac_sha256_generateMsgSchedule_Pipeline_LOOP_SHA256_PREPARE_WT16 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [31:0] W_17_fu_443_p18;
reg   [31:0] W_17_reg_740;
...
mux_165_32_1_1_U225(
    ...
    .din14(tmp_M_29),
    .din15(tmp_M_30),
    .din16(ap_sig_allocacmp_t_3),
    .dout(W_17_fu_443_p18)
);
...
assign add_ln541_fu_437_p2 = (ap_sig_allocacmp_t_3 + 5'd1);
...
assign icmp_ln541_fu_431_p2 = ((ap_sig_allocacmp_t_3 == 5'd16) ? 1'b1 : 1'b0);

assign trunc_ln544_fu_481_p1 = ap_sig_allocacmp_t_3[3:0];

assign w_strm14_din = W_17_reg_740;

endmodule //hmac_sha256_generateMsgSchedule_Pipeline_LOOP_SHA256_PREPARE_WT16
