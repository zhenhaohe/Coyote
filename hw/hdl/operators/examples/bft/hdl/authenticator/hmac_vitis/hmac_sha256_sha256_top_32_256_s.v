...
module hmac_sha256_sha256_top_32_256_s (
...
reg    ap_sync_reg_dup_strm2_U0_ap_start;
...
reg    ap_sync_reg_generateMsgSchedule3_U0_ap_start;
...
reg    ap_sync_reg_sha256Digest_256_U0_ap_start;
...
initial begin
#0 ap_sync_reg_dup_strm2_U0_ap_start = 1'b0;
#0 ap_sync_reg_generateMsgSchedule3_U0_ap_start = 1'b0;
#0 ap_sync_reg_sha256Digest_256_U0_ap_start = 1'b0;
end

hmac_sha256_preProcessing1 preProcessing1_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hmac_sha256_dup_strm2 dup_strm2_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hmac_sha256_generateMsgSchedule3 generateMsgSchedule3_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hmac_sha256_sha256Digest_256_s sha256Digest_256_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
hmac_sha256_fifo_w512_d32_D blk_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w64_d32_D nblk_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w1_d32_D end_nblk_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w64_d32_D nblk_strm1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w1_d32_D end_nblk_strm1_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w64_d32_D nblk_strm2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w1_d32_D end_nblk_strm2_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
hmac_sha256_fifo_w32_d32_D w_strm_U(
    .clk(ap_clk),
    .reset(ap_rst),
    .if_read_ce(1'b1),
    .if_write_ce(1'b1),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_dup_strm2_U0_ap_start <= 1'b0;
    end else begin
        if ((ap_start == 1'b1)) begin
            ap_sync_reg_dup_strm2_U0_ap_start <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_generateMsgSchedule3_U0_ap_start <= 1'b0;
    end else begin
        if ((ap_start == 1'b1)) begin
            ap_sync_reg_generateMsgSchedule3_U0_ap_start <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ap_sync_reg_sha256Digest_256_U0_ap_start <= 1'b0;
    end else begin
        if ((ap_start == 1'b1)) begin
            ap_sync_reg_sha256Digest_256_U0_ap_start <= 1'b1;
        end
    end
end
...
assign dup_strm2_U0_ap_start = (ap_sync_reg_dup_strm2_U0_ap_start | ap_start);
...
assign generateMsgSchedule3_U0_ap_start = (ap_sync_reg_generateMsgSchedule3_U0_ap_start | ap_start);
...
assign sha256Digest_256_U0_ap_start = (ap_sync_reg_sha256Digest_256_U0_ap_start | ap_start);

endmodule //hmac_sha256_sha256_top_32_256_s
